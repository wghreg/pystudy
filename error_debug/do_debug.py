#!/usr/bin/env python3
# -*- coding:utf-8 -*-
'调试: 1. 用print()最大的坏处是将来还得删掉它，想想程序里到处都是print()，运行结果也会包含很多垃圾信息。'
...
别急，在import logging之后添加一行配置再试试：
    import logging
    logging.basicConfig(level=logging.INFO) # 3.5.4 好像默认是info
...
另外，Eclipse(http://www.eclipse.org/)加上pydev(http://pydev.org/)插件也可以调试Python程序。
